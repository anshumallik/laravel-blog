...
$collapsed = 'collapsed';
$active = 'active show';
$adminuser = Request::is('admin/user*');
$frontuser = Request::is('admin/user/frontuser*');
$category = Request::is('admin/category*');
$tag = Request::is('admin/tag*');

?>
 <aside class="sidebar sidebar-default navs-rounded-all ">
     <div class="sidebar-header d-flex align-items-center justify-content-start">
         <a href="../dashboard/index.html" class="navbar-brand">
            <img src="{{ asset('frontend/images/logo.png') }}" alt="" class="logo-sidebar">
             <h4 class="logo-title">My blog</h4>
         </a>
     ...
     <div class="sidebar-body pt-0 data-scrollbar">
         <div class="sidebar-list">
             ...
             <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                 ...
                 <li class="nav-item">
                     <a class="nav-link @yield('dashboard')" aria-current="page" href="{{ route('admin.dashboard') }}">
                         <i class="icon">
                 ...
                 <li class="nav-item">
                     <a class="nav-link {{ $adminuser || $frontuser ? $active : '' }}" 
                     data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                     ...
                     <ul class="sub-nav collapse  {{ $adminuser || $frontuser ? $menu : '' }}" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                         <li class="nav-item ">
                             <a class="nav-link @yield('user')" href="{{ route('admin.user.index') }}">
                                 ...
                                 <span class="item-name"> Admin User </span>
                             </a>
                         </li>
                 ...
                 <li class="nav-item">
                     <a class="nav-link {{ $category || $tag ? $active : '' }}" data-bs-toggle="collapse" 
                     href="#sidebar-special" role="button"
                     ...
                     <ul class="sub-nav collapse {{ $category || $tag ? $menu : '' }}" id="sidebar-special" data-bs-parent="#sidebar-menu">
                         <li class="nav-item">
                         ...
                         <li class="nav-item">
                             <a class="nav-link @yield('tag')" href="{{ route('admin.tag.index') }}">
                                 <i class="icon">
                                     <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                         fill="currentColor">
                                         <g>
                                 ...
                                 <span class="item-name">Blog Tags</span>
                             </a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link @yield('blog')" href="{{ route('admin.blog.index') }}">
                                 <i class="icon">
                                     <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24"
                                         fill="currentColor">
                                         <g>
